 ...
 */
final class Version20220704063323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD email VARCHAR(255) NOT NULL, ADD is_verified TINYINT(1) NOT NULL, DROP pseudo');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD pseudo VARCHAR(20) NOT NULL, DROP email, DROP is_verified');
    }
}
